...
data_folders = 'D:\Share\data\output_eye'
...
if __name__ == '__main__':
    ...
    for r in sub_dir_types_num:
        ...
        print ("|  %-4d  | %-35s | %-10d | %-10d | %-10d | %-11d |    " % (
            count, str(r), a_open, a_close, glass_open, glass_close))

    print ("|  %-4s  | %-35s | %-10d | %-10d | %-10d | %-11d |    " % (
